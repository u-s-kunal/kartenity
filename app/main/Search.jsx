...
function Search() {
  ...
  return (
    <form
      ...
      className="w-full flex  text-amber-100 font-bold  items-center"
    >
      <input
        type="text"
      ...
      <button
        type="submit"
        className="border-none outline-none shadow-none p-3 focus:outline-none focus:ring-0 focus:border-none rounded-full bg-gray-600"
      >
        <SearchIcon />
      </button>
    </form>
